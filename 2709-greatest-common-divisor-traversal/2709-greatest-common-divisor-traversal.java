...
public static void allprime(int n,HashMap<Integer,ArrayList<Integer>>map,int st){
    ...
    public boolean canTraverseAllPairs(int[] nums) {
        // create map of prime factor 
        // mapping each prime factor and the indexes with those factors
        // for ex:  2 : 0,1 
        // then for each set of map, create an edge between those indexes 
        //  0 --- 1 
        // call DFS 
        // check if it's a single connected component or not . 
